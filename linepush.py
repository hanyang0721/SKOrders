...
try:
    ...
    for msg in result:
        ...
        if msg[7].lower() == 'Order'.lower():
            ...
            database.UpdateNotifyOrders(msg[0])
        if msg[7].lower() == 'Reply'.lower():
            line_bot_api.push_message(to, TextSendMessage(text='Order Reply : ' + str(msg[2]) + ' Reply code:' + str(msg[3]) + ' Size:' + str(msg[4]) + ' Price:' + str(msg[5]) + ' Type:' + str(msg[6])))
            database.UpdateNotifyOrders(msg[0])
